...
hWindow = OpenWindow(#winScreen, 0, 0, 400, 250, "窗体穿透",  WindowFlags)

SetWindowLong_(hWindow, #GWL_EXSTYLE, GetWindowLong_(hWindow,#GWL_EXSTYLE)|#WS_EX_LAYERED|#WS_EX_TRANSPARENT)
