...
hWindow = OpenWindow(#WinScreen, 0, 0, 400, 260, "ListViewGadget_滚动列表行", WindowFlags)

StringGadget(#txtScreen, 160, 225, 050, 020, "30") 
ButtonGadget(#btnScreen, 230, 220, 080, 030, "跳到") 

hGadget = ListViewGadget(#lvwScreen, 010, 010, 380, 200) 
