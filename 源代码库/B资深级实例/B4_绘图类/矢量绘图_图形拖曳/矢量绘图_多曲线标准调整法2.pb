...
For i = 0 To Count-1
   ...
   _Graphics\pListPoint() = _DimPoint(i)
Next


If OpenWindow(#winScreen, 0, 0, 600, 450, "矢量绘图_多曲线标准调整法2", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
