...
If ImageID
   If StartDrawing(ImageOutput(ImageID))
      ...
      EllipticalGradient(100,100,200,075)    ;设置渐变区域 
      Circle(100, 100, 100)                  ;绘制需要渐变的图形
      
      EllipticalGradient(300,100,075,200)    ;设置渐变区域 
...
If OpenWindow(#winScreen, 0, 0, 400, 200, "EllipticalGradient_椭圆形渐变效果", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
