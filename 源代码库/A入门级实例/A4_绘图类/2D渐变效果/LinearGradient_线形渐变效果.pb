...
If ImageID
   If StartDrawing(ImageOutput(ImageID))
      ...
      LinearGradient(000,050,000,150)        ;设置渐变区域 
      Box(050, 050, 100, 100)                ;绘制需要渐变的图形
      
      LinearGradient(200,000,400,000)        ;设置渐变区域 
...
If OpenWindow(#winScreen, 0, 0, 400, 200, "LinearGradient_线形渐变效果", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
