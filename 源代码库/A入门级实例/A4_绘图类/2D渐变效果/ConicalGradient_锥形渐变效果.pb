...
If ImageID
   If StartDrawing(ImageOutput(ImageID))
      ...
      ConicalGradient(100, 100, 0.0)         ;设置渐变区域 
      Circle(100, 100, 100)                  ;绘制需要渐变的图形
      
      ConicalGradient(300, 100, 90.0)        ;设置渐变区域 
...
If OpenWindow(#winScreen, 0, 0, 400, 200, "ConicalGradient_锥形渐变效果", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
