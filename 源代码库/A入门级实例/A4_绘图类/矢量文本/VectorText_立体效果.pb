...
Procedure Vector_TextStyle()
   ...
   If StartVectorDrawing(CanvasVectorOutput(#cvsScreen))
      ...
      For k = 1 To 10
         VectorSourceColor($FFFFE0E0)     ;定义路径颜色
         MovePathCursor(50+k, 50-k*0.5)   ;设置起始点
...
If OpenWindow(#winScreen, 0, 0, 600, 250, "VectorText_立体效果", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
