...
Procedure Window_Redrawing()  
    ...
    If StartVectorDrawing(CanvasVectorOutput(#cvsScreen))
      ...
      If IsInsidePath(x, y, #PB_Coordinate_Device)  ; 判断鼠标是否在路径之内
...
If OpenWindow(#winScreen, 0, 0, 500, 300, "IsInsidePath_路径域判断", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
