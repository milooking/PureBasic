...
If OpenWindow(#winScreen, 0, 0, 500, 250, "TranslateCoordinates_移动坐标系", #PB_Window_ScreenCentered|#PB_Window_SystemMenu)
   ...
   If StartVectorDrawing(CanvasVectorOutput(#cvsScreen))
      ...
      TranslateCoordinates(050, 050)    ;采用以(050,050)为原点,移动坐标系
